...
- 在 IP header 中，上层协议字段的值是多少?
  ...
  ![image-20230421113757555](Wireshark-Lab-IP-v7-0/image-20230421113757555.png)
...
![image-20230421113848009](Wireshark-Lab-IP-v7-0/image-20230421113848009.png)
...
![image-20230421113947335](Wireshark-Lab-IP-v7-0/image-20230421113947335.png)

第二个: 

![image-20230421114009587](Wireshark-Lab-IP-v7-0/image-20230421114009587.png)

第三个: 

![image-20230421114026434](Wireshark-Lab-IP-v7-0/image-20230421114026434.png)

可以发现, Id, TTL, Header checksum改变了.

- 哪些字段保持不变? 哪个字段必须保持不变? 哪些字段必须更改? 为什么?

  ![image-20230421114245968](Wireshark-Lab-IP-v7-0/image-20230421114245968.png)
...
![image-20230421114303180](Wireshark-Lab-IP-v7-0/image-20230421114303180.png)
...
![image-20230421114317964](Wireshark-Lab-IP-v7-0/image-20230421114317964.png)
...
![image-20230421114327978](Wireshark-Lab-IP-v7-0/image-20230421114327978.png)

注意到发到第一个message竟然不是ICMPmessage, 而是一个IPdatagram

![image-20230421114340203](Wireshark-Lab-IP-v7-0/image-20230421114340203.png)

打开IP头部, 我们发现, 这仍然是一个ICMP的数据报, 但是在IP的数据部分并没有ICMP头部.

![image-20230421114350725](Wireshark-Lab-IP-v7-0/image-20230421114350725.png)

![image-20230421114403647](Wireshark-Lab-IP-v7-0/image-20230421114403647.png)

- 在第一个和第二个片段中，IP 标头中哪些字段发生了变化?

  第一个fregment: 

  ![image-20230421114415389](Wireshark-Lab-IP-v7-0/image-20230421114415389.png)

  第二片: 

  ![image-20230421114431692](Wireshark-Lab-IP-v7-0/image-20230421114431692.png)
...
- 从原始数据报创建了多少个片?
  ...
  ![image-20230421114440735](Wireshark-Lab-IP-v7-0/image-20230421114440735.png)

- 片段中 IP 标头中的哪些字段发生了变化?

  和上一个结论相同, 红色部分发送了改变, 而蓝色部分没有改变, IP数据报用ID来标识多个片是否属于同一个IP数据报.

![image-20230421114449611](Wireshark-Lab-IP-v7-0/image-20230421114449611.png)
